...
public class ReLogic {
    ...
    public ReLogic(String releaseTag, String[] rarFile) {
    ...
    public void start() {
        ...
        System.out.println(rarFile.length + " parts to download");
        ...
        List<String> url2download = new ArrayList<>();

        for (String url : rarFile) {
            url2download.add(url);
        }
